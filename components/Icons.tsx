...
export function ScholarIcon({ className = "h-4 w-4" }: P) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={`${base} ${className}`}>
      <path d="M12 24a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm0-24L0 9.5l4.84 3.77A7.98 7.98 0 0 1 12 9a7.98 7.98 0 0 1 7.16 4.27L24 9.5 12 0Z" />
    </svg>
  );
}
...
/** Small glyph chosen from a link label — arXiv, code, dataset, project page. */
export function LinkGlyph({ label, className = "h-3 w-3" }: { label: string; className?: string }) {
  ...
  if (l.includes("project") || l.includes("page") || l.includes("site"))
    return (
      <svg
        viewBox="0 0 24 24"
        fill="none"
